...
# import jittor as jt
# import math
# import torch.myutils.model_zoo as model_zoo
# from jittor import nms
# from jittor.models import Resnet50, Resnet18
# from retinanet.myutils import BasicBlock, Bottleneck, BBoxTransform, ClipBoxes
# from retinanet.anchors import Anchors
# from retinanet import losses
#
# import jittor.init as init
...
#             finalResult = [[], [], []]
#
#             finalScores = jt.Tensor([])
#             finalAnchorBoxesIndexes = jt.Tensor([]).long()
#             finalAnchorBoxesCoordinates = jt.Tensor([])
#
#             if jt.has_cuda:
...
#                 finalResult[1].extend(jt.tensor([i] * anchors_nms_idx.shape[0]))
#                 finalResult[2].extend(anchorBoxes[anchors_nms_idx])
#
#                 finalScores = jt.concat((finalScores, scores[anchors_nms_idx]))
#                 finalAnchorBoxesIndexesValue = jt.tensor([i] * anchors_nms_idx.shape[0])
#                 if jt.has_cuda:
#                     finalAnchorBoxesIndexesValue = finalAnchorBoxesIndexesValue
#
#                 finalAnchorBoxesIndexes = jt.concat((finalAnchorBoxesIndexes, finalAnchorBoxesIndexesValue))
#                 finalAnchorBoxesCoordinates = jt.concat((finalAnchorBoxesCoordinates, anchorBoxes[anchors_nms_idx]))
#
